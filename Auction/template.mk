...
STDVERSION = -std=c++17 # proper but requires newer compiler versions (for better or worse)
...
CXXFLAGS = $(STDVERSION) $(STDLIBVERSION) -g -O0 $(WARNINGS) -MMD -MP -msse2 -c
LDFLAGS =  $(STDVERSION) $(STDLIBVERSION) -lpthread
ASANFLAGS = -fsanitize=address -fno-omit-frame-pointer

#  Rules for target executable
$(EXE):
	$(LD) $^ $(LDFLAGS) -o $@
	@echo ""
